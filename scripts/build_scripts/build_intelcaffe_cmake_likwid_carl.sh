...
CAFFE_ROOT="/global/homes/t/tmalas/likwidcaffe"
...
module load likwid/bleeding-edge
...
LDFLAGS="-DLIKWID_PERFMON -I${LIKWID_INC} -L${LIKWID_LIB} -llikwid"
...
cmake -G "Unix Makefiles" \
        ...
        -DCMAKE_INSTALL_PREFIX="${CAFFE_ROOT}/install_likwid_carl" \
...
echo "export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:${mkl_dnn_dir}/lib" > ${CAFFE_ROOT}/install_likwid_carl/set_mkl_path.sh
